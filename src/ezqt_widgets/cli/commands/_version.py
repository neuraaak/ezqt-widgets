# ///////////////////////////////////////////////////////////////
# EZQT_WIDGETS - CLI Version Command
...
This module provides the version command for EzQt-Widgets.
"""
...
def version_command(full: bool) -> None:
    ...
    """
    version = getattr(ezqt_widgets, "__version__", "unknown")
    ...
    if full:
        ...
        url = getattr(ezqt_widgets, "__url__", None)
        if url:
